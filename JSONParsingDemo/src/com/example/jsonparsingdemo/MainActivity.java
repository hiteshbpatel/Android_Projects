...
public class MainActivity extends ListActivity {
	...
	private static String url = "http://72samaj.com/application/adminpanel/vadodarajson.php";
	
	private static final String TAG_CONTACTS = "vadodara";
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		for(int i = 0; i < contacts.length(); i++){
			...
			String gam = "Gam: "+c.getString(TAG_GAM);
